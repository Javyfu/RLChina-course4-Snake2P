...
from networks.critic import Critic_CNN
...
class IQL(object):
    def __init__(self, args, network):
        ...
        self.critic_target = Critic_CNN(self.state_dim, self.action_dim, self.hidden_size)
    ...
    def learn(self):
        ...
        obs = torch.tensor(transitions["o_0"], dtype=torch.float).view(self.batch_size,1, 6,8)
        obs_ = torch.tensor(transitions["o_next_0"], dtype=torch.float).view(self.batch_size,1, 6,8)
