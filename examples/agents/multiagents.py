...
class MultiRLAgents(Baseagent):
    def __init__(self, args):
        ...
        self.args = args
        self.agents = list()
        self.given_net = Critic_CNN(self.args.obs_space,  self.args.action_space, self.args.hidden_size)
        for i in range(self.args.n_player):
            ...
            if self.args.share_net:
                ...
                given_net = Critic_CNN(self.args.obs_space,  self.args.action_space, self.args.hidden_size)
